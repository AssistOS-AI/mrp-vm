...
function buildRetrievalRuntime() {
  ...
  strategyRegistry.register(new ThinkingDBSymbolicStrategy(thinkingdbConfig));
...
export async function createPlugin() {
  ...
  return new ThinkingDBKBPlugin(manifest, contextMatcher);
}
